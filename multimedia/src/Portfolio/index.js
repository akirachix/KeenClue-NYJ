    ...
    return(
        ...
        <div className="info">
           <div className="details">
            <div className="title">
            <div className="introduction"><img src="/Images/Maggy.jpeg" className="pictures" alt="Gitahi"/>
...
<div className="details">
            <div className="title">
            <div className="introduction"><img src="/Images/Tuukuo.jpeg" className="pictures" alt="Gitahi"/>
            <div className="education">
                <h2>Gitahi</h2>
